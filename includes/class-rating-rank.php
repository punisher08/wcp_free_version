<?php 
/**
 * Add Rating Rank computation to Multi Rating plugin rating form submission.
 * 
...
if( !class_exists('WCP_MR_RatingRank') ){

class WCP_MR_RatingRank {
	 ...
	 */
	public static function save_ratingrank() {
		...
		if ( wp_verify_nonce( $ajax_nonce, Multi_Rating::ID . '-nonce' ) ) {
			...
			/* Rating Rank */
			$ndf_data_mr_ratingrank = ($rating_result['adjusted_star_result']) * ( $rating_result['count'] );
